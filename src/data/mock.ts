import type { StatCard, ActivityItem, Screen, InboxThread } from '@/types';
...
export const STAT_CARDS: StatCard[] = [
  ...
  { key: 'documents', count: 23,  label: 'Documents', sublabel: '3 awaiting sign',  icon: 'FileText' },
  { key: 'crm',       count: 47,  label: 'CRM',       sublabel: '$14M pipeline',    icon: 'Users' },
  { key: 'billing',   count: 6,   label: 'Billing',   sublabel: '2 past due',       icon: 'DollarSign' },
];
...
export const SCREENS: Record<string, Screen> = {
  ...
  documents: {
    icon: 'FileText', title: 'Documents', subtitle: 'Drafted from approved templates',
    items: [
  ...
  billing: {
    icon: 'DollarSign', title: 'Billing', subtitle: 'Invoices reconciled to engagements',
    items: [
...
export const INBOX_THREADS: InboxThread[] = [
  {
    ...
    extracted: [
      { icon: 'Building2', label: 'Property',    value: '412 Magnolia',       tone: 'accent' },
      { icon: 'DollarSign', label: 'Offer',      value: '$1.215M · 25% down', tone: 'mint' },
